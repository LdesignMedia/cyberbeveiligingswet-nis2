...
EXAMPLES OF EVIDENCE
   ...
   Criteria for open source components should take into account the voluntary nature of open source projects. Acquirers of such components must
(50)
...
(51)
       In addition, to those mentioned in the mapping table at the end of this section, consider the following:
...
(61) In addition to those mentioned in the mapping table at the end of this section, consider the following:
      a)   NIST Special Publication NIST SP 800-215, Guide to a Secure Enterprise Network Landscape, https://doi.org/10.6028/NIST.SP.800-215,
           accessed 7 May 2025.
...
91
     “Privileged access rights are access rights provided to an identity, a role or a process that allows the performance of activities that typical users or
