...
| **Board / management body** preparing for governance + training duty | [`EXECUTIVE-SUMMARY.md`](./EXECUTIVE-SUMMARY.md) — 5-minute brief satisfying NIS2 art. 20 awareness floor |
| **Sector-specific reader** (digital infra / healthcare / energy / manufacturing / public admin) | [`sectors/`](./sectors/) — per-sector guides covering scope, NL authority, adjacent regimes, top risks, quick wins |
